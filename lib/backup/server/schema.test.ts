...
describe("convertDateFields（日期字符串 → Date）", () => {
  it("以 At 结尾且可解析的字符串转 Date", () => {
    const out = convertDateFields({ id: "1", createdAt: "2026-09-14T10:00:00.000Z", publishedAt: "2026-09-15T00:00:00.000Z" });
  ...
  it("非 At 结尾字段不动（含 Date 实例原样保留）", () => {
    const d = new Date();
    const out = convertDateFields({ id: "1", name: "x", updated: "2026-01-01T00:00:00.000Z", obj: d });
